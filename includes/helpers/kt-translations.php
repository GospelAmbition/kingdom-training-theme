...
function kt_get_default_translations() {
    return array(
        ...
        'newsletter_page_header_description' => 'Stay connected with the latest training resources, articles, and updates on Media to Disciple Making Movements.',
        'newsletter_form_description' => 'Get the latest training resources, articles, and insights delivered directly to your inbox. Join our community of disciple makers committed to using media strategically for Kingdom impact.',
        'newsletter_what_to_expect' => 'What to Expect',
        'newsletter_expect_item_1' => 'Latest articles and insights on Media to Disciple Making Movements',
        'newsletter_expect_item_2' => 'Practical tools and strategies for disciple makers',
        'newsletter_expect_item_3' => 'Stories from the field and testimonies of impact',
        'newsletter_privacy_statement' => 'We respect your privacy. Unsubscribe at any time.',
        'newsletter_privacy_link_text' => 'Learn more about our privacy policy',
